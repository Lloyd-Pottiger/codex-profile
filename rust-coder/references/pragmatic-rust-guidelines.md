...
# Pragmatic Rust Guidelines (Bundled)

This is a vendored snapshot of the Pragmatic Rust Guidelines from `rust-guidelines/src/guidelines/`.

- If the current workspace contains `rust-guidelines/`, prefer reading that copy.
- Otherwise, use this file as the reference text.
